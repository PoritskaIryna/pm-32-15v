...
for i in range(3):
    ant_colony_optimization(points, n_ants=10+i, n_iterations=100, alpha=1, beta=1, evaporation_rate=0.5, Q=1)
    print(f"Count of cities: {len(points)}")
    # Generate, save, and load route map
    route_map = generate_route_map()
    loaded_route_map = load_route_map()
